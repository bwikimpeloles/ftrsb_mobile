...
class _SupplierInformationFinanceState
  ...
  final Uri _url = Uri.parse(
      'https://docs.google.com/spreadsheets/d/1vpQHAeo5We8P2ph9LI8nrHevRdSea7iYA362qXkYCPs/edit?usp=sharing');
  ...
  generateCsv() async {
    ...
    final File file = await (File(
            '${generalDownloadDir.path}/supplier_export_$formattedDate.csv')
        .create());
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Note: Do use same company name to avoid error for dropdown in Expenses page.',
