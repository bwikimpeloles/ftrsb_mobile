...
import 'package:ftrsb_mobile/SalesScreen/prospect/prospectList.dart';
import 'package:ftrsb_mobile/SalesScreen/sidebar_navigation.dart';

class DistrChannelListProspect extends StatefulWidget {
  const DistrChannelListProspect({Key? key}) : super(key: key);

  @override
  State<DistrChannelListProspect> createState() => _DistrChannelListProspectState();
}

class _DistrChannelListProspectState extends State<DistrChannelListProspect> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        child: CustomAppBar(bartitle: 'Prospect'),
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    ProspectList(channel: data['channel']),
                              ),
                            );
                          },
                          child: Column(
