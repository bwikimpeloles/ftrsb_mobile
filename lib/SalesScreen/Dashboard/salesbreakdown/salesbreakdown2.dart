...
class SalesBreakdownB2C2 extends StatefulWidget {
  SalesBreakdownB2C2({Key? key,}) : super(key: key);

  @override
  State<SalesBreakdownB2C2> createState() => _SalesBreakdownB2C2State();
}

class _SalesBreakdownB2C2State extends State<SalesBreakdownB2C2> {
