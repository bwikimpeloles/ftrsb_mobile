...
class SalesBreakdownB2B2 extends StatefulWidget {
  SalesBreakdownB2B2({
    Key? key,
  }) : super(key: key);

  @override
  State<SalesBreakdownB2B2> createState() => _SalesBreakdownB2B2State();
}

class _SalesBreakdownB2B2State extends State<SalesBreakdownB2B2> {
