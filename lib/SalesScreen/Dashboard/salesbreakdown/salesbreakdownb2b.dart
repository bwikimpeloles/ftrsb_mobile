...
class SalesBreakdownB2B extends StatefulWidget {
  String? selectedValue;
  SalesBreakdownB2B({Key? key, required this.selectedValue}) : super(key: key);

  @override
  State<SalesBreakdownB2B> createState() => _SalesBreakdownB2BState();
}

class _SalesBreakdownB2BState extends State<SalesBreakdownB2B> {
