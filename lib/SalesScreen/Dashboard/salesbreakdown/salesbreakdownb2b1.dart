...
class SalesBreakdownB2B1 extends StatefulWidget {
  SalesBreakdownB2B1({
    Key? key,
  }) : super(key: key);

  @override
  State<SalesBreakdownB2B1> createState() => _SalesBreakdownB2B1State();
}

class _SalesBreakdownB2B1State extends State<SalesBreakdownB2B1> {
