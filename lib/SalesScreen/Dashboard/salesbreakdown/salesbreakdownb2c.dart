...
class SalesBreakdownB2C extends StatefulWidget {
  String? selectedValue;
  SalesBreakdownB2C({Key? key, required this.selectedValue}) : super(key: key);

  @override
  State<SalesBreakdownB2C> createState() => _SalesBreakdownB2CState();
}

class _SalesBreakdownB2CState extends State<SalesBreakdownB2C> {
